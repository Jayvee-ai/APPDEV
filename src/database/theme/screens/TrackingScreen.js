...
const styles = StyleSheet.create({
  ...
  subtitle: { color: COLORS.textMuted, fontSize: 13.5, marginBottom: 20 },
  ...
  certFooter: { alignItems: 'flex-end', flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
  signatureBlock: { alignItems: 'center', width: 170 },
  signatureLine: { borderTopColor: COLORS.text, borderTopWidth: 1.5, marginBottom: 7, width: 160 },
  signName: { color: COLORS.text, fontSize: 12, fontWeight: '800' },
  signOffice: { color: COLORS.textMuted, fontSize: 11, marginTop: 4 },
  qrBox: { alignItems: 'center', minWidth: 112 },
  ...
  pendingQrPlaceholder: { alignItems: 'center', backgroundColor: '#fff', borderColor: COLORS.border, borderRadius: 8, borderStyle: 'dashed', borderWidth: 1.5, height: 100, justifyContent: 'center', marginTop: 12, paddingHorizontal: 16 },
